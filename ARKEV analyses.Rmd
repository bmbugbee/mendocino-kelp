...
kruskal.test(species_richness ~ treatment, data = fish)

library(FSA)

fish_dunn = dunnTest(species_richness ~ treatment, data = fish, method = "bh")
fish_dunn$res
```
...
ggplot(fish_summary, aes(x = treatment, y = mean_richness, fill = treatment)) +
  geom_bar(stat = "identity", color = "black", width = 0.7) +
  geom_errorbar(aes(ymin = mean_richness - se_richness,
                    ymax = mean_richness + se_richness),
                width = 0.2) +
